...
export const About = () => {
        ...
        const features = [
            ...
            },
            {
                ...
                desc: "Optimisez l'efficacité de votre entreprise avec mes services en administration et gestion. Je vous accompagne dans la mise en place de processus efficaces, la gestion des ressources et l'amélioration continue pour maximiser la rentabilité.",
                href: "#"
            },
            {
                icon:
                ...
                desc: "Naviguez avec confiance dans le paysage fiscal complexe. Mes services en fiscalité et veille juridique assurent la conformité fiscale et vous tiennent informés des évolutions légales impactant vos activités.",
                href: "#"
            },
            {
                icon:
