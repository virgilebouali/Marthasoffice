...
export const Cta = () => {
  return (
    <div className="z-0 mt-12 bg-gray-200 py-4">
        ...
        <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-5/12">
          <div className="flex lg:py-12">
            <Image src="/corpo1.jpg" width={500} height={500}
              className="w-full  shadow-lg shadow-black/20 lg:ml-[50px]" alt="image" />
          </div>
        </div>
        <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12 shadow-2xl">
          <div className="flex h-full items-center p-6 text-center text-white lg:pl-12 lg:text-left"
          style={{
            ...
            <div className="lg:pl-12">
              ...
              <Link href="#contact" className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white  hover:bg-white group">
